...
(function($) {
    ...
    $.extend(true, $.hik.jtable.prototype, {
        ...
        _createDateInputForField: function(field, fieldName, value) {
            var $input = base._createDateInputForField.apply(this, arguments);
        ...
        _addFilterColumnsToHeaderRow: function($tr) {
            ...
            $.each(self._columnList, function() {
                self._createHeaderCellForFilter(this, self.options.fields[this])
                    .appendTo($tr);
            });

            if (this.options.actions.updateAction !== undefined) {
                self._createHeaderCellForFilter(null, {})
                    .appendTo($tr);
            }
        ...
        _createFieldForFilter: function(fieldName, fieldOptions) {
            ...
            if (fieldOptions.filter === 'range') {
                ...
                if (fieldOptions.options && fieldOptions.type !== 'radiobutton') {
                    $field.find('select')
                        .prepend($('<option />'));
                }
